...
use SnowflakeAPILib\Http\HttpCallBack;
...
class HttpCallBackCatcher extends HttpCallBack
{
    /**
     * Http request
     * @var SnowflakeAPILib\Http\HttpRequest
     */
    private $request;

    /**
     * Http Response
     * @var SnowflakeAPILib\Http\HttpResponse
     */
    private $response;
     ...
     * @return SnowflakeAPILib\Http\HttpRequest
     */
     ...
     * @return SnowflakeAPILib\Http\HttpResponse
     */
